...
#ifndef KLARNACOREWEBVIEW_SWIFT_H
#define KLARNACOREWEBVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KlarnaCoreWebView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17KlarnaCoreWebView15InternalWebView")
...
@class UIScrollView;
@interface InternalWebView (SWIFT_EXTENSION(KlarnaCoreWebView)) <UIScrollViewDelegate>
/// <ul>
///   <li>
...
@class WKFrameInfo;
@interface InternalWebView (SWIFT_EXTENSION(KlarnaCoreWebView)) <WKUIDelegate>
...
@interface InternalWebView (SWIFT_EXTENSION(KlarnaCoreWebView)) <WKNavigationDelegate>
