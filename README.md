...
Once you have your Swift package set up, adding PrimerKlarnaSDK as a dependency is as easy as adding it to the `dependencies` value of your `Package.swift`.
