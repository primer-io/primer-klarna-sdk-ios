...
#ifndef PRIMERKLARNASDK_SWIFT_H
#define PRIMERKLARNASDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PrimerKlarnaSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15PrimerKlarnaSDK26PrimerKlarnaViewController")
@interface PrimerKlarnaViewController : UIViewController
...
@interface PrimerKlarnaViewController (SWIFT_EXTENSION(PrimerKlarnaSDK)) <KlarnaPaymentEventListener>
